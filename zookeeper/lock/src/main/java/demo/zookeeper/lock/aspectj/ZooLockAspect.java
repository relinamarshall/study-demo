package demo.zookeeper.lock.aspectj;
...
import demo.zookeeper.lock.annotation.LockKeyParam;
...
public class ZooLockAspect {
     ...
     * 切入点
     */
    @Pointcut("@annotation(demo.zookeeper.lock.annotation.ZooLock)")
    public void doLock() {
    }
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        if (CharSequenceUtil.isBlank(zooLock.key())) {
