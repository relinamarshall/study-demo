...
import demo.mapper.pagehelper.MapperPagehelperApplicationTest;
 ...
 *
 * @author Wenzhou
 * @since 2023/3/21 17:13
 */
@Slf4j
public class UserMapperTest extends MapperPagehelperApplicationTest {
    /**
     * userMapper
     */
    @Autowired
    ...
    public void testInsertList() {
        ...
        for (int i = 4; i < 14; i++) {
            ...
            User user = User.builder().name("testSave" + i)
                    .password(SecureUtil.md5("123456" + salt))
                    .salt(salt).email("testSave" + i + "@qq.com")
                    .phoneNumber("1730000000" + i).status(1)
                    .lastLoginTime(new DateTime())
                    .createTime(new DateTime())
