package demo.mybatis.plus.activerecord;
 ...
 *
 * @author Wenzhou
 * @since 2023/3/21 16:26
 */
@Slf4j
public class ActiveRecordTest extends MybatisPlusApplicationTest {
    /**
    ...
    public void testActiveRecordUpdate() {
        ...
        Assert.assertTrue(new Role().update(new UpdateWrapper<Role>().lambda()
                .set(Role::getName, "普通用户-1").eq(Role::getId, 2)));
    }
